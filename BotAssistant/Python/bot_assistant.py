...
class Bot_assistant:
    ...
    def __init__(self, interface) -> None:
        ...
        if is_user_folder:
            ...
            self.home_directory = pathlib.Path.home().joinpath('.', 'save')
    ...
    def _closest_command(self, input_string, command_list):
        if input_string.lower() not in command_list:
            ...
            if suggestion:
                res = res + get_message('maybe_meant').replace('{maybe}', ', '.join(suggestion))
            return res
