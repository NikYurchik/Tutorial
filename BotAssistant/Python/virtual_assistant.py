...
messages = {
    ...
    'ru': {
        ...
        'un_command': 'Неизвестная команда "{command}".',
    ...
    'uk': {
        ...
        'un_command': 'Невідома команда "{command}".',
...
class ValueList(UserList):
    ...
    def append(self, values):
        ...
        # elif len(values) > 0:
            ...
            for item in val_list:
                self.exists(item, is_raise = 1)
                ps = self._create_element(item)
                self.data.append(ps)
            # return ps
        return None
...
if __name__ == '__main__':
    ...
    print(ab('add', 'contact', ['Dany','380634567890,+380990123456','2001/11/21']))
